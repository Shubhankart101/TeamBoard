...
SPECTACULAR_SETTINGS = {
    'TITLE': 'TeamBoard B2B Knowledge Base API',
    'DESCRIPTION': 'B2B Knowledge Base API platform providing curated technical Q&A, query logging, and admin dashboard analytics.',
    'VERSION': '1.0.0',
